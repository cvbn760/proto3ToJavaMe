...
public enum InputDataUtil {
    ...
    public static String getDestinationDirectory(String... inputValues) {
        ...
        if (inputValues.length == 1) {
            ...
            if (inputValues[0].length() <= "--java_out=".length()) {
                throw new net.jarlehansen.proto2javame.io.exception.InvalidInputException("The destination directory was invalid, remember to include --java_out=");
            }
    ...
    private static String getCurrentDirectory() {
        try {
            ...
            throw new net.jarlehansen.proto2javame.io.exception.InvalidInputException(var1.getClass().getName() + " when trying to find the current directory", var1);
        }
    }
    ...
    public static void isValidNumberOfParameters(String... inputValues) {
        if (inputValues.length != 2) {
            throw new net.jarlehansen.proto2javame.io.exception.InvalidInputException("The number of input parameters must be 2, it was: " + inputValues.length + ". Values: " + Arrays.toString(inputValues) + ". Valid syntax: --java_out=/path/to/dir path/to/protoFile.proto");
        }
    }

    private static void isValidDirectory(String path) {
        if (!(new File(path)).isDirectory()) {
            throw new net.jarlehansen.proto2javame.io.exception.InvalidInputException("The --java_out directory was not specified or is not a valid directory, value: " + path);
        }
    }
