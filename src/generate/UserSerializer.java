package generate;// Generated by proto2javame, Thu Nov 11 15:13:07 MSK 2021.
...
public final class UserSerializer extends AbstractOutputWriter {
	...
	public static class Builder {
		...
		public Builder addElementAge(final uint32 element) {
			if(!hasAge) {
				hasAge = true;
			}
			age.addElement(element);
			return this;
		}
	...
	private int computeNestedMessageSize() {
		int messageSize = 0;
		messageSize += ComputeSizeUtil.computeListSize(fieldNumberAge, net.jarlehansen.protobuf.javame.SupportedDataTypes.DATA_TYPE_CUSTOM, age);
	...
	public void writeFields(final OutputWriter writer) throws IOException {
		...
		writer.writeList(fieldNumberAge, net.jarlehansen.protobuf.javame.SupportedDataTypes.DATA_TYPE_CUSTOM, age);
	...
	static boolean populateBuilderWithField(final InputReader reader, final Builder builder, final int fieldNumber) throws IOException {
		...
		switch (fieldNumber) {
			...
			case fieldNumberLastName:
				...
				break;
			case fieldNumberAge:
				Vector vcAge = reader.readMessages(fieldNumberAge);
				for(int i = 0 ; i < vcAge.size(); i++) {
					byte[] eachBinData = (byte[]) vcAge.elementAt(i);
					Uint32.Builder builderAge = Uint32.newBuilder();
					InputReader innerInputReader = new InputReader(eachBinData, unknownTagHandler);
					boolean boolAge = true;
					int nestedFieldAge = -1;
					while(boolAge) {
						nestedFieldAge = getNextFieldNumber(innerInputReader);
						boolAge = Uint32.populateBuilderWithField(innerInputReader, builderAge, nestedFieldAge);
					}
					eachBinData = null;
					innerInputReader = null;
					builder.addElementAge(builderAge.build());
				}
				break;
